...
import { BsArrowUpRightCircleFill, BsArrowDownLeftSquareFill } from "react-icons/bs"
...
function TransactionTypeFilter() {
	...
	const colorClasses = useCallback((transactionType: TransactionTypes) => {
		...
		if (transactionType in positionsAndTransactionClass.walletFilter.transactionType) {
