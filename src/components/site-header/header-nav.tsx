...
export default function HeaderNav() {
	return (
		<nav
			className="bg-white dark:bg-neutral-900 fixed top-0 left-0 w-full z-20 border-b border-zinc-100 dark:border-zinc-700"
			// style={{ borderColor: "rgb(34, 34, 34)", borderWidth: "2px" }}
		>
