	...
	return (
		...
		>
			...
			<div
                ...
                text-white text-xs rounded shadow-lg transition-opacity duration-100 ${showTooltip ? "opacity-100 visible border dark:border-yellow-400" : "opacity-0 invisible"}`}
