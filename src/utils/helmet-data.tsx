...
const helmetData: HelmetData = {
	...
	"/register": (
		<BasicHelmet
			pageTitleData="Register | Fortuna"
	...
	"/register-username": (
		<BasicHelmet
			pageTitleData="Register Username | Fortuna"
	...
	"/ownership": (
		<BasicHelmet
			pageTitleData="Ownership | Fortuna"
	...
	"/creator/studio": (
		<BasicHelmet
			pageTitleData="Creator Studio | Fortuna"
	...
	"/creator/create-content": (
		<BasicHelmet
			pageTitleData="Create Content | Fortuna"
	...
	"/contact": (
		<BasicHelmet
			pageTitleData="Contact Us | Fortuna"
